...
cfg.position_embedding = 'learned' # 'sine' # choices=('sine', 'learned'), help="Type of positional embedding to use on top of the image features"
...
cfg.hidden_dim = 256 # Size of the embeddings (dimension of the transformer)
