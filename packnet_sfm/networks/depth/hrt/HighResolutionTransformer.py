...
class HighResolutionTransformer(nn.Module):
    ...
    def forward(self, x):
        ...
        x0 = F.upsample(y_list[0], scale_factor=4, mode='bilinear')
        x1 = F.upsample(y_list[1], scale_factor=4, mode='bilinear')
        x2 = F.upsample(y_list[2], scale_factor=4, mode='bilinear')
        x3 = F.upsample(y_list[3], scale_factor=4, mode='bilinear')
        
        disps = []
        disps.append(self.last_layer[0](x0))
        disps.append(self.last_layer[1](x1))
        disps.append(self.last_layer[2](x2))
        disps.append(self.last_layer[3](x3))
