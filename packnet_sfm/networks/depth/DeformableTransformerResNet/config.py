...
cfg.num_feature_levels = 1 # 4 # number of feature levels

# * Transformer
cfg.enc_layers = 0 # Number of encoding layers in the transformer
cfg.dec_layers = 1 # Number of decoding layers in the transformer
cfg.dim_feedforward = 256 # 2048 # Intermediate size of the feedforward layers in the transformer blocks
cfg.dropout = 0.1 # Dropout applied in the transformer
cfg.nheads = 8 # 8 # Number of attention heads inside the transformer's attentions
cfg.pre_norm = False
cfg.dec_n_points = 16
cfg.enc_n_points = 16
