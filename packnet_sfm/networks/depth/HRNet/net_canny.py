...
class CannyNet(nn.Module):
    ...
    def forward(self, img):
        ...
        for pos_i in range(4):
            ...
            is_oriented_i = (inidices_positive == pos_i) * 1
            is_oriented_i = is_oriented_i + (inidices_positive == neg_i) * 1
            pos_directional = all_filtered[:, pos_i]
            neg_directional = all_filtered[:, neg_i]
