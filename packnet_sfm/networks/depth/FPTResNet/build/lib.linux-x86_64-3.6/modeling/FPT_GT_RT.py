...
class FPT_GT_RT(nn.Module):
    def __init__(self, feature_dim, with_norm='none', upsample_method='bilinear'):
        ...
        if with_norm != 'none':
            ...
            self.fpt_p4 = nn.Conv2d(feature_dim*4, feature_dim, 3, padding=1)
    ...
    def forward(self, res2, res3, res4, res5):
        ...
        fpt_p3_out = torch.cat((self.rt_p3_p2(fpn_p3_1, fpn_p2_1), 
            self.gt_p3_p4(fpn_p3_1,fpn_p4_1), self.gt_p3_p5(fpn_p3_1,fpn_p5_1), fpn_p3_1), 1)
        fpt_p2_out = torch.cat((self.gt_p2_p3(fpn_p2_1, fpn_p3_1), 
