...
class GroundTrans(nn.Module):
    ...
    def forward(self, x_low, x_high):
        ...
        y = y.view(batch_size, self.inter_channels, x_low.shape[2], x_low.shape[3])
