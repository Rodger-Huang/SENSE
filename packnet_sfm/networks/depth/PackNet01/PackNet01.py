...
class PackNet01(nn.Module):
    ...
    kwargs : dict
        Extra parameters
    """
    def __init__(self, dropout=None, version=None, mode=None, **kwargs):
        super().__init__()
        ...
        #         self.pointwise_1 = torch.nn.Sequential(
        #             torch.nn.Conv2d(16, 64, 1),
        #             torch.nn.GroupNorm(16, 64),
        #             torch.nn.Sigmoid() 
        #         )
        #         self.pointwise_2 = torch.nn.Sequential(
        #             torch.nn.Conv2d(32, 64, 1),
        #             torch.nn.GroupNorm(16, 64),
        #             torch.nn.Sigmoid() 
        #         )
        #         self.pointwise_3 = torch.nn.Sequential(
        #             torch.nn.Conv2d(64, 128, 1),
        #             torch.nn.GroupNorm(16, 128),
        #             torch.nn.Sigmoid() 
        #         )
        #         self.pointwise_4 = torch.nn.Sequential(
    ...
    def forward(self, x, semantics_feature=None):
        """
        ...
        # if self.mode == 'attention':
        #     if self.network == 'SGDepth':
        #         semantic_feature4 = self.pointwise_4(semantics_feature[1])
        #         iconv4 = semantic_feature4 * iconv4 + iconv4
        # elif self.mode == 'original':
        #     pass
        # else:
        ...
        # if self.mode == 'attention':
        #     if self.network == 'SGDepth':
        #         semantic_feature3 = self.pointwise_3(semantics_feature[2])
        #         iconv3 = semantic_feature3 * iconv3 + iconv3
        # elif self.mode == 'original':
        #     pass
        # else:
        #     raise ValueError('Unknown mode {}'.format(self.mode))
        ...
        # if self.mode == 'attention':
        #     if self.network == 'SGDepth':
        #         semantic_feature2 = self.pointwise_2(semantics_feature[3])
        #         iconv2 = semantic_feature2 * iconv2 + iconv2
        # elif self.mode == 'original':
        #     pass
        # else:
        #     raise ValueError('Unknown mode {}'.format(self.mode))
        ...
        # if self.mode == 'attention':
        #     if self.network == 'SGDepth':
        #         semantic_feature1 = self.pointwise_1(semantics_feature[4])
        #         iconv1 = semantic_feature1 * iconv1 + iconv1
        # elif self.mode == 'original':
        #     pass
        # else:
        #     raise ValueError('Unknown mode {}'.format(self.mode))
        ...
        if self.training:
            return [disp1, disp2, disp3, disp4] # , [iconv1, iconv2, iconv3, iconv4]
        else:
            return disp1
